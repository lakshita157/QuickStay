...
const RoomDetails = () => {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      {/* Room Details */}
      <div className='flex flex-colmd:flex-row items-start md:items-center gap-2'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        ...
        <div className='flex flex-col items-start gap-4'>
          ...
          <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull transition-all cursor-pointerb'>Contact Now</button>
        </div>
    </div>
  )
}
